...
\begin{figure}[!ht]
    ...
    % Pod figura 1
    \subfloat[Konfiguracja kanału 0]{
        \includegraphics[width=0.8\textwidth]{media/11Różne_temp_OGRZANA_TERMOPARA.png}
...
\newgeometry{left=0.5cm,right=1cm,top=1cm,bottom=1cm}
\begin{figure}[!ht]
    \centering
        % Pod figura 1
        \subfloat[Kod do ledu zielonego]{
            \includegraphics[width=0.5\textwidth]{media/14Led_zielony.png}
            
            \label{fig:sub7}}
        % Pod figura 2
        \subfloat[Kod do ledu czerwonego]{
            \includegraphics[width=0.52\textwidth]{media/14Led_czerwony.png}
            \label{fig:sub8}
        }
    ...
    \subfloat[Led zielony]{
        \includegraphics[width=0.5\textwidth]{media/14_1Led_zielony.png}
        
        \label{fig:sub5}}
    % Pod figura 2
    \subfloat[Led czerwony]{
        \includegraphics[width=0.5\textwidth]{media/14_1Led_czerwony.png}
        \label{fig:sub6}
    }
    \caption{Konfiguracja kanałów modułu}
    \label{fig:main3}
