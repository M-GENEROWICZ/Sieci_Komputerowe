...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{media/xd2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{media/xd4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{media/xd3.png}
...
Umożliwia to odczyt adresów zmiennych procesowych urządzenia w PLC. Na rysunku \ref{fig:adresy} %O adresach i co oznaczają te OUT PVD itd.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{media/xd.png}
