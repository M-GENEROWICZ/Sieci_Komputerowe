...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{0.5cm}
        \LARGE
        Badanie właściwości metrologicznych toru
        pomiarowego z modulacją AM przeznaczonego do
        współpracy z czujnikami wielkości nieelektrycznych
            
        \vspace{1.5cm}
            
        \textbf{Marek Generowicz}

        \normalsize      
        \textcolor{gray}{30.12.2024}
        \vfill
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{media/fig1.png}
...
\begin{graph}[ht]
    \centering
    \includegraphics[width=1\linewidth]{media/wyk1.png}
...
\begin{graph}[ht]
    \centering
    \includegraphics[width=1\linewidth]{media/wyk2.png}
...
\begin{figure}[!ht]
    ...
    \subfloat[Pierwszy wykres z oscyloskopu]{
        \includegraphics[width=0.5\textwidth]{media/fig2.png}
        \label{fig:sub1}
    }
    % Pod figura 2
    \subfloat[Drugi wykres z oscyloskopu]{
        \includegraphics[width=0.5\textwidth]{media/fig3.png}
        \label{fig:sub2}
    }
    \hfill
            \subfloat[Trzeci wykres z oscyloskopu]{
                \includegraphics[width=0.5\textwidth]{media/fig7.png}
                \label{fig:sub0}
    }
...
\begin{figure}[!ht]
    ...
    \subfloat[Czwarty wykres z oscyloskopu]{
        \includegraphics[width=0.5\textwidth]{media/fig4.png}
        \label{fig:sub3}
    }
    % Pod figura 4
    \subfloat[Piąty wykres z oscyloskopu]{
        \includegraphics[width=0.5\textwidth]{media/fig5.png}
        \label{fig:sub4}
    }
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{media/fig6.png}
...
\begin{graph}[ht]
    \centering
    \includegraphics[width=1\linewidth]{media/wyk3.png}
    \caption{Wartość napięcia zmierzonego w zależności od przemieszczenia rdzenia.}
    \label{wyk3}
\end{graph}
\newpage
...
\begin{graph}[ht]
    \centering
    \includegraphics[width=1\linewidth]{media/wyk4.png}
    \caption{Wartość błędu bezwzględnego w zależności od przemieszczenia rdzenia.}
    \label{wyk4}
\end{graph}
