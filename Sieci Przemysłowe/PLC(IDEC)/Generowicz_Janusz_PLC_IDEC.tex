...
\begin{figure}[H]
    \centering
        ...
        \subfloat[Skrzynka sterownicza (zdjęcie z konspektu)]{    
            \centering
            \includegraphics[width=0.45\textwidth]{media/0_Wnętrze_skrzynki.jpeg}
            \label{fig:zdj2}}
        % Pod figura 1
...
\begin{figure}[H]
    \centering
        ...
        \subfloat[Moduł I]{    
            \centering
            \includegraphics[width=0.45\textwidth]{media/2_4_Moduł_1_Pełne_pomerańćz.png}
            \label{fig:zdj12}}
        % Pod figura 1
        \subfloat[Moduł II]{
            \includegraphics[width=0.45\textwidth]{media/2_3_Moduł_2_zbiornik_pełny.png}        
            \label{fig:zdj13}}
